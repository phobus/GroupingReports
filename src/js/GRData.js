(function(window, document, undefined) {
  ...
  GRData.prototype.aggregation = function(type, data) {
    return (this._afn[type] || this._afn['undefined'])(data, type);
  };

  GRData.prototype.createGroupingRow = function(aggregate) {
    var column, row = {};
  ...
  GRData.prototype.createTotal = function(data, aggregate) {
  ...
  GRData.prototype.grouping = function(data, groupBy, columns) {
  ...
  GRData.prototype.recursiveGrouping = function(data, groupBy, aggregate, index) {
  ...
  GRData.prototype.groupAndAggregate = function(data, columnGroupBy, aggregate) {
  ...
  GRData.prototype.reduce = function(data, aggregate) {
    var group, column;
    for (var i = 0, l = data.length; i < l; i++) {
      group = data[i];
      for (var j = 0, s = aggregate.length; j < s; j++) {
  ...
  GRData.prototype.toArray = function(obj) {
    var arr = [];
    for (var i in obj) {
      arr.push(obj[i]);
    }
